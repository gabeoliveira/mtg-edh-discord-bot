**Available Commands (brackets are not needed for passing arguments)**

**!join [commander name]**: Joins the game with the referenced commander
...
**!overview**: Shows the game current status
**!order**: Shows player order
**!pass**: Pass the turn
